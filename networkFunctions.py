...
def cmd_fetch_1(option_is_from_data, option_release, option_regexp, option_dry_run):
   ...
   # option_dry_run = True
    ...
    #print('filedir_url  : %s' % filedir_url)
    filedir_html = auth_wget(filedir_url)
    #print('filedir_html : %s' % filedir_html)
...
def list_search_1(my_choice_0):
    ...
    option_regexp = ''
    #print('my_choice_0    : %s' % my_choice_0)
    #print('option_release : %s' % option_release)
    (liste_releases_1) = cmd_fetch_1(option_is_from_data, option_release, option_regexp, option_dry_run)
...
def cmd_load_files(files_array, folder):
    ...
    cmd_fetch_2(option_mthreads, filedir_url, files_array)

    return

def cmd_fetch(option_is_from_data, option_release, option_regexp, option_mthreads, option_dry_run): # used with Projet_CheckRootFiles/
